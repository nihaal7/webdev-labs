...
#########################
current_user = CurrentUser(first_name='Erick', last_name='Rubi', email='erub03@gmail.com', username='erub03',random_quote='')
...
@app.route('/quote')
def exercise2():
    current_user.random_quote = random.choice(quotes)
